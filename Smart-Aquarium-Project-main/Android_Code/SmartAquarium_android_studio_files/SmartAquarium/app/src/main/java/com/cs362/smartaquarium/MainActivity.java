    ...
    private void setButtonListeners()
    {
        ...
        lightBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    lightBtn.setBackground(getDrawable(R.drawable.den_selected));
                    lightBtn.setForeground(getDrawable(R.drawable.den_selected));

                }
                else
                {
                    lightBtn.setBackground(getDrawable(R.drawable.den_unselected));
                    lightBtn.setForeground(getDrawable(R.drawable.den_unselected));
                }
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN: {
                        ...
                        view.setBackground(getDrawable(R.drawable.ca_unselected));
                        view.setForeground(getDrawable(R.drawable.ca_unselected));
                        break;
                    }
                    case MotionEvent.ACTION_UP:{
                        Button view = (Button) v;
                        view.setBackground(getDrawable(R.drawable.ca_selected));
                        view.setForeground(getDrawable(R.drawable.ca_selected));
...
/*
    ...
    public boolean isIpValid()
    {
        ...
        {
            Toast.makeText(MainActivity.this, "Nhập IP!", Toast.LENGTH_SHORT).show();
            return false;
        }
        ...
        if(!m.matches())
        {
            Toast.makeText(MainActivity.this, this.ip + " IP không đúng!", Toast.LENGTH_SHORT).show();
            return false;
        }
